...
# Input parsing
with open("Day#18_Puzzle#1_Input.txt") as input_data:
    numbers = [line.strip() for line in input_data.read().split("\n")[:-1]]
    sum = Pair(numbers[0], -1, None, None)
    for num in numbers[1:]:
        sum = Pair('[' + sum.string_me() + ',' + num + ']', -1, None, None)
    ...
    # Magnitude lvl.7
    print("Final sum's magnitude:", sum.magnitude())
