...
# The heights reached, and the launch parameters that hit the target
wuthering_heights = []
HITS = []
...
# Return the axis to normal
if negate_x_axis:
    HITS = [-hit for hit in HITS]

# Solution
print("The highest shot scores a height of", max(wuthering_heights))
print("There are", len(HITS), "unique shot parameters that hit the target.")
print(HITS)
